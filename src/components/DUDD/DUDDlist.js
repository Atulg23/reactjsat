...
import AddDUDD from "./AddDUDD";
import EditDUDD from "./EditDUDD";
...
const Delivery_UnitsDD = () => {
 ...
 //TODO       
        instance.get('/Delivery_unit_director/')
            .then(response => {
                //console.log(response)
                for (const key in response.data) {
                    duddData.push({
                        id:response.data[key].id,
                        du_id : response.data[key].du_id ,
...
//  console.log(datalist);
    ...
    const handleClickDelete = (id) => {
        ...
        console.log(id);
        axios.delete(`/Delivery_unit_director/${id}`)
        .then(res => {
            console.log(res);
    ...
    return (
        ...
        <Paper className="mainContent">
            ...
            />
             ...
             <AddDUDD open={open} handleClose={handleClose} addInput={addInput} /> 
             <EditDUDD edit={edit} handleClose={handleCloseEdit} editInput={editInput} view={view}/>
...
export default Delivery_UnitsDD;
